...
exampleZip.namelist()
# ['cats/catnames.txt', 'cats/zophie.jpg', 'spam.txt']
...
# 'Compressed file is 2.81x smaller!'
exampleZip.close()
...
from pathlib import Path
p = Path.home()
with zipfile.ZipFile(p / 'example.zip') as exampleZip:
    exampleZip.extractall()
    # extracted to cwd
    exampleZip.extractall('C:\\delicious')
    # extracted to C:\delicious
    exampleZip.extract('spam.txt')
    # extract spam.txt to cwd
    exampleZip.extract('spam.txt', 'C:\\some\\new\\folders')
    # 'C:\\some\\new\\folders\\spam.txt'
    # Python will create this folder if it doesn't exist ^^
