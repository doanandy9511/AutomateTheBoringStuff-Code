...
# You can retrieve a web page element by calling select() and passing
# a string of a CSS selector for the element you are looking for
...
# soup.select('input[name]')-   All elements named <input> that have a name 
